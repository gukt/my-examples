package net.bafeimao.examples.web.service;

import net.bafeimao.examples.web.domain.User;
import net.bafeimao.examples.web.exception.DuplicateEmailException;
import net.bafeimao.examples.web.exception.DuplicateNameException;
import net.bafeimao.examples.web.repository.GenericRepository;
import net.bafeimao.examples.web.repository.GenericRepositoryImpl;
import net.bafeimao.examples.web.repository.UserRepository;
import net.bafeimao.examples.web.util.HResult;
